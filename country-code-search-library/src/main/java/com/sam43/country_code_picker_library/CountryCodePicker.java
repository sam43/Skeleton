...
public class CountryCodePicker extends RelativeLayout {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null && xmlWidth != null && (xmlWidth.equals(LayoutParams.MATCH_PARENT + "") || xmlWidth.equals(LayoutParams.MATCH_PARENT + "") || xmlWidth.equals("fill_parent") || xmlWidth.equals("match_parent"))) {
...
//        Log.d(TAG, "getEditText_registeredCarrierNumber");
    ...
    public void launchCountrySelectionDialog(final String countryNameCode) {
        ...
        CountryCodeDialog.openCountryCodeModal(codePicker, countryNameCode);
    }
